...
const translations = {
  en: {
    title: "🎉 Hey there! 🎉",
    intro: "We have some exciting information for you about your previous squat performance analysis. You'll be receiving messages like:",
    feedback: "Feedback",
    motivation: "Motivation",
    safety: "Safety Notes",
    suggestion: "Suggestion",
    whatToDo: "Here's what you need to do:",
    step1: "Check out the messages: Visit the page where you'll see all the messages we've prepared for you.",
    ...
    step3: "Review the messages again: Take a moment to go through the messages once more.",
  ...
  ja: {
    title: "🎉 こんにちは！ 🎉",
    intro: "前回のスクワットパフォーマンス分析に関する興味深い情報をお届けします。以下のようなメッセージを受け取ります:",
    feedback: "フィードバック",
    motivation: "モチベーション",
    safety: "安全上の注意",
    suggestion: "提案",
    whatToDo: "以下の手順に従ってください:",
    step1: "メッセージを確認: 私たちが準備したすべてのメッセージが表示されるページにアクセスしてください。",
    step2: "個人設定アンケートに記入: 分析をあなたのニーズに合わせて調整できるようにアンケートに回答してください。",
    step3: "メッセージを再度確認: もう一度メッセージを確認する時間を取ってください。",
